...
export class AuthService {
  ...
  delete(data){
    return this.http.delete<any>(`https://localhost:3000/api/${data}/delete`, httpOptions)
  }

  update(id, data){
    return this.http.put<any>(`https://localhost:3000/api/${id}/update`, data, httpOptions)
    }
